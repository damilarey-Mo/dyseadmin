...
$sql="INSERT INTO  tbllocations(Locations) VALUES(:locations)";
...
if($lastInsertId)
{
$msg="locations Created successfully";
}
else 
{
...
<head>
	...
	<title>Dyse| Admin Create Location</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Create Locations</h2>
